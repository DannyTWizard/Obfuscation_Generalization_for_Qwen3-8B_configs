...
# Job 3: leave_out_score_add_new_full_xml
echo "Submitting job 3: leave_out_score_add_new_full_xml"
sbatch --job-name=summary_score slurm_scripts/train_dispatch.sbatch \
    "${COMMON_ARGS[@]}" \
    data=leave_out_score_add_new_full_xml \
    config_name=run_nsp_summary_score_add_new
