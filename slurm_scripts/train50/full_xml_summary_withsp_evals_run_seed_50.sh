...
sbatch --job-name=eval_war slurm_scripts/eval_dispatch.sbatch \
    ...
    training_run_name=run_withsp_summary_war_ovs_hedged_add_info_summary_ts_50_data_leave_out_war_full_xml
...
sbatch --job-name=eval_syco slurm_scripts/eval_dispatch.sbatch \
    ...
    training_run_name=run_withsp_summary_sycophancy_ovs_hedged_add_info_summary_ts_50_data_leave_out_sycophancy_full_xml
...
sbatch --job-name=eval_score slurm_scripts/eval_dispatch.sbatch \
    ...
    training_run_name=run_withsp_summary_score_ovs_hedged_add_info_summary_ts_50_data_leave_out_score_full_xml
...
sbatch --job-name=eval_code slurm_scripts/eval_dispatch.sbatch \
    ...
    training_run_name=run_withsp_summary_code_ovs_hedged_add_info_summary_ts_50_data_leave_out_code_full_xml
