#!/bin/bash
# =============================================================================
# Eval Dispatcher for: monitor_informed_pen_less_stronger
# Discovers checkpoints and submits eval jobs for all configs
#
# Usage:
#   ./run_evals_monitor_informed_pen_less_stronger.sh              # all checkpoints
#   ./run_evals_monitor_informed_pen_less_stronger.sh 100 200 500  # only specified steps
# =============================================================================
...
TRAINING_RUN_NAME="monitor_informed_pen_less_stronger"
...
for STEP in "${STEPS_TO_RUN[@]}"; do
    for CONFIG_PATH in "${EVAL_CONFIGS[@]}"; do
        ...
        JOB_NAME="eval-monitor_informed_pen_less_stronger-${CONFIG_NAME}-step${STEP}"
