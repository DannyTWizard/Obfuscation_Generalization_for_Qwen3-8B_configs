...
def main():
    ...
    duplicates = [name for name in train_dataset_names if train_dataset_names.count(name) > 1]
    if duplicates:
        raise ValueError(f"Duplicate train dataset names not allowed: {set(duplicates)}")
